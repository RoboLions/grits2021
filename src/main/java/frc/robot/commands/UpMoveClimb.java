...
public class UpMoveClimb extends CommandBase {
  /**
  ...
  public static final int LOWER_MAX_ENCODER_COUNTS = 0; //TODO placeholder
  public static final int ACTUAL_MAX_ENCODER_COUNTS = 0; //TODO placeholder

  private final ClimberSubsystem climberSubsystem;
  private final XboxController driverController = RobotContainer.driverController;
  
  public UpMoveClimb(ClimberSubsystem climb) {
  ...
  public boolean isFinished() {
    ...
    return (climberEncoderCounts > LOWER_MAX_ENCODER_COUNTS);
  }
}
