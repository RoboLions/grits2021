...
public class AutoPath8Mirror extends SequentialCommandGroup {
  /**
   * Creates a Trench (3 ball)
   */
  public AutoPath8Mirror(final DriveSubsystem driveSubsystem, final IntakeSubsystem intakeSubsystem, ArmSubsystem armSubsystem) {
